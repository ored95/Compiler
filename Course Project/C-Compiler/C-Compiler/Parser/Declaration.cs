...
namespace Parsing
{
    public partial class CParsers
    {
        ...
        public static NamedParser<Decln>
            Declaration
        { get; } = new NamedParser<Decln>("declaration");
        ...
        { get; } = new NamedParser<DeclnSpecs>("declaration-specifiers");
        ...
        public static NamedParser<ImmutableList<InitDeclr>>
            InitDeclaratorList
        { get; } = new NamedParser<ImmutableList<InitDeclr>>("Init-declarator-list");
        ...
        public static NamedParser<InitDeclr>
            InitDeclarator
        { get; } = new NamedParser<InitDeclr>("Init-declarator");
        ...
        { get; } = new NamedParser<StorageClsSpec>("storage-class-specifier");
        ...
        public static NamedParser<TypeSpec>
            TypeSpecifier
        { get; } = new NamedParser<TypeSpec>("Type-specifier");
        ...
        public static NamedParser<TypeQual>
            TypeQualifier
        { get; } = new NamedParser<TypeQual>("Type-qualifier");
        ...
        public static NamedParser<Declr>
            Declarator
        { get; } = new NamedParser<Declr>("declarator");
        ...
        public static NamedParser<ImmutableList<PointerModifier>>
            Pointer
        { get; } = new NamedParser<ImmutableList<PointerModifier>>("pointer");
        ...
        public static NamedParser<ParamTypeList>
            ParameterTypeList
        { get; } = new NamedParser<ParamTypeList>("parameter-Type-list");
        ...
        public static NamedParser<ImmutableList<ParamDecln>>
            ParameterList
        { get; } = new NamedParser<ImmutableList<ParamDecln>>("parameter-list");
        ...
        public static NamedParser<ImmutableList<TypeQual>>
            TypeQualifierList
        { get; } = new NamedParser<ImmutableList<TypeQual>>("Type-qualifier-list");
        ...
        public static NamedParser<Declr>
            DirectDeclarator
        { get; } = new NamedParser<Declr>("direct-declarator");
        ...
        public static NamedParser<EnumSpec>
            EnumSpecifier
        { get; } = new NamedParser<EnumSpec>("enum-specifier");
        ...
        public static NamedParser<ImmutableList<Enumr>>
            EnumeratorList
        { get; } = new NamedParser<ImmutableList<Enumr>>("enumerator-list");
        ...
        public static NamedParser<Enumr>
            Enumerator
        { get; } = new NamedParser<Enumr>("enumerator");
        ...
        public static NamedParser<String>
            EnumerationConstant
        { get; } = new NamedParser<string>("enumeration-constant");
        ...
        { get; } = new NamedParser<StructOrUnionSpec>("struct-or-union-specifier");
        ...
        public static NamedParser<StructOrUnion>
            StructOrUnion
        { get; } = new NamedParser<StructOrUnion>("struct-or-union");
        ...
        { get; } = new NamedParser<ImmutableList<StructDecln>>("struct-declaration-list");
        ...
        public static NamedParser<StructDecln>
            StructDeclaration
        { get; } = new NamedParser<StructDecln>("struct-declaration");
        ...
        { get; } = new NamedParser<SpecQualList>("specifier-qualifier-list");
        ...
        { get; } = new NamedParser<ImmutableList<StructDeclr>>("struct-declarator-list");
        ...
        public static NamedParser<StructDeclr>
            StructDeclarator
        { get; } = new NamedParser<StructDeclr>("struct-declarator");
        ...
        { get; } = new NamedParser<ParamDecln>("parameter-declaration");
        ...
        public static NamedParser<AbstractDeclr>
            AbstractDeclarator
        { get; } = new NamedParser<AbstractDeclr>("abstract-declarator");
        ...
        { get; } = new NamedParser<AbstractDeclr>("direct-abstract-declarator");
        ...
        public static NamedParser<Initr>
            Initializer
        { get; } = new NamedParser<Initr>("initializer");
        ...
        public static NamedParser<Initr>
            InitializerList
        { get; } = new NamedParser<Initr>("initializer-list");
        ...
        public static NamedParser<TypeName>
            TypeName
        { get; } = new NamedParser<TypeName>("Type-name");
        ...
        public static NamedParser<String>
            TypeDefName
        { get; } = new NamedParser<String>("typedef-name");
